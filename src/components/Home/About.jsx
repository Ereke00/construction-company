        ...
        <div className={styles.wrapper}>
            ...
            <div className={styles.main_services_wrapper}>
                <div className={styles.main_services_header}>
                    ...
                    <p>У нас есть большой опыт в области электромонтажных работ в жилых и коммерческих помещениях, и любая работа не может быть слишком маленькой. Наши клиенты ценят наш профессионализм, трудовую этику и конкурентоспособные цены.
                    </p>
                </div>
