...
import companyIcon from '../../img/иконка2.png'
import mailIcon from '../../img/mail_icon2.jpg'
import callIcon from '../../img/call_icon2.jpg'
...
const Header = () => {
    return (
        <div className={styles.root}>
            ...
            <div className={styles.brand_contact}>
                <img className={styles.company_icon} src={companyIcon} alt="" />
            ...
            <div className={styles.nav_bar_button}>
                <div className={styles.nav_bar}>
                    <Link to="/">Басты бет</Link>
                    <Link to="/">Компания жайлы</Link>
                    <Link to="/apartaments">Жылжымайтын мүлік</Link>
                    <Link to="/complexes">Тұрғын үй кешені</Link>
                    <Link to="/">Біздің контактілер</Link>
                </div>

                <button className={styles.question_button}>
                    Сұрақтарыңыз бар ма?
